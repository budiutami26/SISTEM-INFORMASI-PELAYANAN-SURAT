                        ...
                        <form method="POST" action="{{ 'prestasi' }}">
                            ...
                            <div class=" form-group">
                                ...
                                <select class="form-select" id="program_studi" name="program_studi"
                                    ...
                                    <option value="D4 Teknik Pengendalian Pencemaran Lingkungan">D4 Teknik Pengendalian
                                        Pencemaran Lingkungan</option>
                                    <option value="D4 Pengembangan Produk Agroindustri">D4 Pengembangan Produk Agroindustri
                                    </option>
